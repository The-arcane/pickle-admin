...
export function EditCourtClientPage({ court, organisations, sports, organisationId }: { court: Court | null, organisations: Organisation[], sports: Sport[], organisationId: number }) {
    ...
    const organisation = organisations[0]; // Since arena login has only one org
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                  ...
                                  <Input id="organisation_id_display" value={organisation?.name ?? ''} disabled />
