...
import { saveChannel, deleteChannel, inviteMembers, removeMember } from '@/app/livingspace/channels/[id]/actions';
import type { Channel, ChannelMember, User } from '@/app/livingspace/channels/[id]/types';
...
export function EditChannelClientPage({ channel, members, users }: { channel: Channel | null, members: ChannelMember[], users: User[] }) {
    ...
    const performInvite = async () => {
        ...
        setIsInviteConfirmDialogOpen(false);
    };
            ...
            <form action={handleFormAction} className="space-y-8">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        <Button variant="outline" type="button" asChild><Link href="/arena/channels">Cancel</Link></Button>
