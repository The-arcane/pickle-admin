...
import { EditCoachClientPage } from '@/app/livingspace/coaches/[id]/client';
import type { Coach } from '@/app/livingspace/coaches/[id]/types';

export default async function ArenaEditCoachPage({ params }: { params: { id: string } }) {
    ...
    if (!organisationId) {
        return <p>You are not associated with a Sports Venue.</p>;
    }
