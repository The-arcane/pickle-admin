    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="flex flex-wrap gap-2">
            ...
            <Button asChild className="flex-grow bg-rose-100 text-rose-800 hover:bg-rose-200 dark:bg-rose-900/50 dark:text-rose-300 dark:hover:bg-rose-900/80 focus-visible:ring-rose-500"><Link href="/livingspace/events"><PartyPopper className="mr-2 h-4 w-4" />Events</Link></Button>
