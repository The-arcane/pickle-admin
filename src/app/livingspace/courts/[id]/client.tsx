...
export function EditCourtClientPage({ court, organisation, sports, organisationId }: { court: Court | null, organisation: Organisation | null, sports: Sport[], organisationId: number }) {
    ...
    const handleFormAction = async (formData: FormData) => {
        ...
        if (result?.error) {
            ...
            router.push('/livingspace/courts');
            router.refresh();
        }
    };
                ...
                <form action={handleFormAction} className="space-y-8">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                            <Button variant="outline" type="button" asChild className="flex-1 sm:flex-initial"><Link href="/livingspace/courts">Cancel</Link></Button>
                    ...
                    <div className="flex items-center justify-end gap-2 sticky bottom-0 bg-background py-4">
                        <Button variant="outline" type="button" asChild><Link href="/livingspace/courts">Cancel</Link></Button>
