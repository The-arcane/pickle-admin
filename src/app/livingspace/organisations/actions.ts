...
export async function updateOrganization(formData: FormData) {
    ...
    revalidatePath('/livingspace/organisations');
    revalidatePath('/livingspace'); // To update the name in the layout
...
export async function addFlat(formData: FormData) {
    ...
    revalidatePath(`/livingspace/organisations/flats/${building_number_id}`);
