            ...
            <Table>
              ...
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className="hidden sm:table-cell">Tennis Court 1</TableCell>
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden sm:table-cell">Basketball Court</TableCell>
                  <TableCell className="hidden sm:table-cell">
                ...
                <TableRow>
                  ...
                  <TableCell className="hidden sm:table-cell">Tennis Court 2</TableCell>
                  <TableCell className="hidden sm:table-cell">
