...
export function InvitationsClientPage({ 
    ...
    const handleDownloadTemplate = () => {
        ...
        link.setAttribute("download", "invitations_template.csv");
    ...
    return (
        <>
                            ...
                            {loading ? (
                                ...
                                <TableRow>
                                    <TableCell colSpan={5} className="text-center h-24">
                                        No users found. Invite some to get started!
                                    </TableCell>
                                </TableRow>
                            )}
                        </TableBody>
            ...
            <Dialog open={isInviteDialogOpen} onOpenChange={(isOpen) => {
                ...
                <DialogContent>
                    <DialogHeader>
                        <DialogTitle>Invite New Users via CSV</DialogTitle>
                        <DialogDescription>
            ...
            <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>This will remove the user's invitation. This action cannot be undone.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
